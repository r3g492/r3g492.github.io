...
/**
*/
export const Cell = Object.freeze({ Dead:0,"0":"Dead",Alive:1,"1":"Alive",Selected:2,"2":"Selected", });
/**
*/
export class Universe {
    ...
    */
    select_cell(row, column) {
        wasm.universe_select_cell(this.ptr, row, column);
    }
    /**
    */
    reset_every_selected_to_alive() {
        wasm.universe_reset_every_selected_to_alive(this.ptr);
    }
    /**
    * @returns {number}
    */
